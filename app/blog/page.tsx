    ...
    <DefaultLayout>
      <section className="relative">
        ...
        <div className="mx-auto max-w-3xl pb-12 pt-32 md:pb-20 md:pt-40">
          {/* Section header */}
          <div className="pb-16">
            <h1 className="mb-4 text-5xl font-bold">Customer stories</h1>
            <p className="text-lg text-gray-700">
            We talked with some of our customers about why they chose Yuzuu, how they integrated it with their sales pipeline, what do they use Yuzuu for, and the results they’ve gotten
            </p>
          </div>
          {/*Categories 
